...
3. While in the same home directory as `docker-compose.py` start docker-compose by issuing this command on you terminal: `docker-compose up`
...
4. run (python3 app.py) to run experiment
5. use (http://localhost:5100/ping) to see the deployed model
6. run curl -X POST http://localhost:5100/predict \
...
7. EDA_Vic contains the notebook.