...
if __name__=='__main__':
    ...
    ref_job_id = "8120831c8a714d1ca345382c4f5bbbf3" #helpers.generate_uuid()
    ...
    cur_job_id = "1edbba05d9f0427eb19af69526509321"  #helpers.generate_uuid()
    ...
    model_type = helpers.get_model_type("8120831c8a714d1ca345382c4f5bbbf3")
    model = helpers.load_model_from_pickle(f"8120831c8a714d1ca345382c4f5bbbf3_{model_type}")
    r = check_model_drift(
